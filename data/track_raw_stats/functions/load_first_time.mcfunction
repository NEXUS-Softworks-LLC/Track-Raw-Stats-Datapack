...
data merge storage track_raw_stats:data {PackVersion:"0.4"}

scoreboard objectives add ts_extra dummy
scoreboard players set 60 ts_extra 60

#
#> Advancement / Triggers
#
scoreboard objectives add ts_FillBucket dummy "Filled Bucket"
scoreboard objectives add ts_ItemsConsumed dummy "Consumed Item"
scoreboard objectives add ts_ChangeDim dummy "Changed Dimension"
scoreboard objectives add ts_BrewedPot dummy "Brewed Potion"
scoreboard objectives add ts_StartRiding dummy "Started Riding"
scoreboard objectives add ts_SleptInBed dummy "Slept in Bed"
scoreboard objectives add ts_CrossShot dummy "Shot Crossbow"
scoreboard objectives add ts_CrossKill dummy "Crossbow Kill"
scoreboard objectives add ts_CuredVillager dummy "Cured Zombie Villager"
scoreboard objectives add ts_TargetHit dummy "Hit Target"

#
#> Advancement / Triggers / Location
#
scoreboard objectives add ts_TimePlayInSecs dummy "Play Time in Seconds"
scoreboard objectives add ts_TimePlayInMins dummy "Play Time in Mins"
scoreboard objectives add ts_TimePlayInHrs dummy "Play Time in Hours"

scoreboard objectives add ts_TimeDimOverworld dummy "Overworld Time"
scoreboard objectives add ts_TimeDimNether dummy "Nether Time"
scoreboard objectives add ts_TimeDimEnd dummy "End Time"

scoreboard objectives add ts_TimeBioPln dummy "Plains Time"
scoreboard objectives add ts_TimeBioDes dummy "Desert Time"
scoreboard objectives add ts_TimeBioFor dummy "Forest Time"
scoreboard objectives add ts_TimeBioNethFor dummy "Nether Forest Time"
scoreboard objectives add ts_TimeBioSav dummy "Savanna Time"
scoreboard objectives add ts_TimeBioTai dummy "Taiga Time"
scoreboard objectives add ts_TimeBioJun dummy "Jungle Time"
scoreboard objectives add ts_TimeBioBad dummy "Badlands Time"
scoreboard objectives add ts_TimeBioSwmp dummy "Swamp Time"
scoreboard objectives add ts_TimeBioManSwmp dummy "Mangrove Swamp Time"
scoreboard objectives add ts_TimeBioLush dummy "Lush Caves Time"
scoreboard objectives add ts_TimeBioDeltas dummy "Basalt Deltas Time"
scoreboard objectives add ts_TimeBioSpikes dummy "Ice Spikes Time"
scoreboard objectives add ts_TimeBioOcean dummy "Ocean Time"
scoreboard objectives add ts_TimeBioVoid dummy "Void Time"

scoreboard objectives add ts_TimeStrHold dummy "Stronghold Time"
scoreboard objectives add ts_TimeStrPyrDes dummy "Desert Pyramid Time"
scoreboard objectives add ts_TimeStrPyrJun dummy "Jungle Pyramid Time"
scoreboard objectives add ts_TimeStrCity dummy "End City Time"
scoreboard objectives add ts_TimeStrFort dummy "Nether Fortress Time"
scoreboard objectives add ts_TimeStrBast dummy "Bastion Remnant Time"
scoreboard objectives add ts_TimeStrMans dummy "Woodland Mansion Time"
scoreboard objectives add ts_TimeStrShaft dummy "Mineshaft Time"
scoreboard objectives add ts_TimeStrMonument dummy "Ocean Monument Time"
scoreboard objectives add ts_TimeStrOutpost dummy "Pillager Outpost Time"
scoreboard objectives add ts_TimeStrWreck dummy "Shipwreck Time"
scoreboard objectives add ts_TimeStrIgloo dummy "Igloo Time"
scoreboard objectives add ts_TimeStrVillage dummy "Village Time"
scoreboard objectives add ts_TimeStrVillDes dummy "Desert Village Time"
scoreboard objectives add ts_TimeStrVillPln dummy "Plains Village Time"
scoreboard objectives add ts_TimeStrVillSnw dummy "Snowy Village Time"
scoreboard objectives add ts_TimeStrVillTai dummy "Taiga Village Time"
scoreboard objectives add ts_TimeStrVillSav dummy "Savanna Village Time"

# check for terralith scoreboard
execute store result score terralith ts_extra run execute if score %USED tr.first = %USED tr.first
execute if predicate track_raw_stats:terralith_installed run function track_raw_stats:load_terralith
...
scoreboard objectives add ts_IntBrewing minecraft.custom:minecraft.interact_with_brewingstand "Brewing"
...
scoreboard objectives add ts_TimePlayInTicks minecraft.custom:minecraft.play_time "Play Time in Ticks"
...
scoreboard objectives add ts_RaidTrigger minecraft.custom:raid_trigger
scoreboard objectives add ts_RaidWin minecraft.custom:raid_win
#
# Crafted
#
